...
const { getCourses, getCourseById, createCourse, updateCourse, deleteCourse, enrollCourse, getMyCourses, getEnrolledCourses } = require('../controllers/courseController');
